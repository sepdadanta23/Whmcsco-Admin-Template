...
<div id="widgetSettingsDropdown" class="btn-group widget-settings pull-left">
    ...
    <ul id="widgetSettingsDropdownMenu" class="dropdown-menu pull-left" aria-labelledby="widgetSettings">
        <li>
